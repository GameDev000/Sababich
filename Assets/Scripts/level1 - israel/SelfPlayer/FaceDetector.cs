...
public class FaceDetector : MonoBehaviour
{
    ...
    public Rect DetectFace(Texture2D texture)
    {
        ...
        try
        {
            ...
            float anchorSize = (bestIndex < 512 ? 8f : 16f) / InputSize;

            float cy = anchorY + boxesCpu[0, bestIndex, 0] * anchorSize;
            float cx = anchorX + boxesCpu[0, bestIndex, 1] * anchorSize;
            float h = boxesCpu[0, bestIndex, 2] * anchorSize;
            float w = boxesCpu[0, bestIndex, 3] * anchorSize;
