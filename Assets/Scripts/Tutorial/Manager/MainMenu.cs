...
public class MainMenu : MonoBehaviour
{
    ...
    /// <summary>
    /// Loads a gameplay scene directly from the control panel.
    /// This bypasses win/lose checks because it is an intentional manual level jump.
    /// </summary>
    public void LoadSceneFromControlPanel(string sceneName)
    {
        if (string.IsNullOrEmpty(sceneName))
        {
            Debug.LogWarning("[MainMenu] LoadSceneFromControlPanel received an empty scene name.");
            return;
        }
